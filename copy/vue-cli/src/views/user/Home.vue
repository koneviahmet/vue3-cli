  ...
  <div class="py-6 px-4 min-h-screen">
    ...
    <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-base-100 p-6 rounded-lg shadow">
        ...
        <div v-else>
            ...
            <table class="table w-full">
              ...
              <tbody>
                <tr v-for="user in recentUsers" :key="user.id" class="border-b border-base-300">
                  <td class="py-2">{{ user.name }} {{ user.lastName }}</td>
                  <td class="py-2">{{ user.email }}</td>
                  <td class="py-2 text-right">
                    <router-link :to="`/user/detail/${user.id}`" class="btn btn-sm btn-primary">View</router-link>
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="mt-4 text-right">
            <router-link to="/user/list" class="text-primary hover:underline">View all users</router-link>
          </div>
        </div>
      </div>
      ...
      <div class="bg-base-100 p-6 rounded-lg shadow">
        ...
        <div class="space-y-3">
          <router-link to="/user/signIn" class="btn btn-primary w-full flex items-center justify-between">
          ...
          <router-link to="/user/list" class="btn btn-secondary w-full flex items-center justify-between">
          ...
          <router-link to="/user/search" class="btn btn-accent w-full flex items-center justify-between">
