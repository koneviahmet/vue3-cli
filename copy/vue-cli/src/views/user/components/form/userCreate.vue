    ...
    <div class="card-body p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="form-control">
          ...
          <input type="text" placeholder="Enter your last name" v-model="lastName" class="input input-bordered ">
      ...
      <div class="text-center">
        ...
        <router-link to="/user/logIn" class="text-primary hover:underline font-medium">
          Log in
        </router-link>
      </div>
    </div>
